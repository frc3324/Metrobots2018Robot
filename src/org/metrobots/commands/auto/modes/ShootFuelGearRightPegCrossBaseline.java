...
public class ShootFuelGearRightPegCrossBaseline extends CommandGroup {
	public ShootFuelGearRightPegCrossBaseline() {
		this.addSequential(new ShootFuel(3, 1));
		this.addSequential(new Strafe(0.5, 1));
		this.addSequential(new DriveForward(-1, 1.5));
